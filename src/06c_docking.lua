...
function LucidUI.Window:_dockRect(zone)
    ...
    local halfH = (vp.Y - m * 3) / 2

    local map = {
        ["left"]         = { x = m,                y = m,                w = halfW, h = vp.Y - m * 2 },
        ["right"]        = { x = vp.X - halfW - m, y = m,                w = halfW, h = vp.Y - m * 2 },
        ["top"]          = { x = m,                y = m,                w = vp.X - m * 2, h = halfH },
        ["bottom"]       = { x = m,                y = vp.Y - halfH - m, w = vp.X - m * 2, h = halfH },
        ["top-left"]     = { x = m,                y = m,                w = halfW, h = halfH },
        ["top-right"]    = { x = vp.X - halfW - m, y = m,                w = halfW, h = halfH },
