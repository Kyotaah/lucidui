...
function LucidUI.Window:_buildSavedThemesSettings()
    ...
    Create("TextLabel", {
        ...
        TextColor3 = self.Theme.TextPrimary, BackgroundTransparency = 1,
        TextXAlignment = Enum.TextXAlignment.Left,
        Position = UDim2.fromOffset(14, 0), Size = UDim2.new(1, -100, 1, 0), Parent = savedHeader,
    })
    local savedArrow = Create("TextLabel", {
        Text = "v", Font = Enum.Font.GothamBold, TextSize = 14,
        TextColor3 = self.Theme.TextMuted, BackgroundTransparency = 1,
        Position = UDim2.new(1, -24, 0, 0), Size = UDim2.fromOffset(20, 40), Parent = savedHeader,
    })
    ...
    Create("UIListLayout", {
        Padding = UDim.new(0, 4), SortOrder = Enum.SortOrder.LayoutOrder, Parent = savedList,
    })
    ...
    local function rebuildSaved()
        ...
        if #names == 0 then
            local empty = Create("TextLabel", {
                Text = "No saved themes yet", Font = Enum.Font.Gotham, TextSize = 12,
                TextColor3 = self.Theme.TextMuted, BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, 0, 32), LayoutOrder = 1, Parent = savedList,
            })
        ...
        for i, name in ipairs(names) do
            local rowWrap = Create("Frame", {
                ...
                BackgroundTransparency = 0.5, LayoutOrder = i, Parent = savedList,
            })
            Corner(8, rowWrap)
            ...
            local delBtn = Create("TextButton", {
                ...
                Size = UDim2.fromOffset(28, 32), Position = UDim2.new(1, -32, 0, 0),
                ZIndex = 3, Parent = rowWrap,
            })
